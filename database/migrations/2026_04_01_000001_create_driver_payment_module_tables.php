...
return new class extends Migration
{
    ...
    {
        Schema::dropIfExists('transportista_liquidation_meta');
        Schema::dropIfExists('planilla_pago_chofer_recibos');
        Schema::dropIfExists('planillas_pago_chofer');
        Schema::dropIfExists('recibo_chofer_items');
        Schema::dropIfExists('recibos_chofer');
        Schema::dropIfExists('driver_import_run_rows');
        Schema::dropIfExists('driver_import_runs');
        Schema::dropIfExists('driver_import_settings');
        Schema::dropIfExists('driver_liquidation_settings');
    }
};
