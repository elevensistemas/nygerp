...
@section('title', 'Importación transporte')

@section('content')
  <div class="page-header">
    <div class="title-block">
      <h1 class="h3 mb-1">Importación transporte</h1>
    ...
    <div class="page-actions">
      <a class="btn btn-outline-secondary" href="{{ route('traffic.transportes.index') }}">
        <i class="fa-solid fa-arrow-left me-1"></i> Volver a transportes
      </a>
    </div>
  </div>
  ...
  <form method="POST" action="{{ route('traffic.transportes.import-config.store') }}">
    @csrf
      ...
      <div class="card-body">
        <div class="row g-3 mb-4">
          <div class="col-md-6">
            ...
            <input class="form-control" type="text" name="name" value="{{ old('name', $format->name ?? '') }}" placeholder="Ej: Formato transporte">
          </div>
          <div class="col-md-3">
